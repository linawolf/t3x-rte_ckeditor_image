...
class RteImagesDbHook
{
     ...
     *
     * In detail, the relative image path is changed to an absolute image path before the data is
     * displayed in the RTE text box.
     *
     * @param string        $value
...
////DebuggerUtility::var_dump(__METHOD__);
        ...
        foreach ($imgSplit as $key => $v) {
            ...
            if (($key % 2) === 1) {
                ...
                // TODO Why is an absolute URL used here? Is this still required?
...
////DebuggerUtility::var_dump($imgSplit);
...
//DebuggerUtility::var_dump($siteHost);
...
//DebuggerUtility::var_dump($sitePath);
...
//DebuggerUtility::var_dump($absoluteUrl);
...
//DebuggerUtility::var_dump('XX');
//DebuggerUtility::var_dump($originalImageFile);
//exit;
                ...
                if ($originalImageFile instanceof File) {
                    ...
                    if (($absoluteUrl !== $imageFileUrl) && ($absoluteUrl !== $originalImageFile->getPublicUrl())) {
                        ...
                        // -> generate img source from storage base path and identifier instead
...
//DebuggerUtility::var_dump(__METHOD__);
//DebuggerUtility::var_dump($imgSrc);
//exit;
